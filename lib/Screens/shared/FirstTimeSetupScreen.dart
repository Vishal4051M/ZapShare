...
class _FirstTimeSetupScreenState extends State<FirstTimeSetupScreen> {
  ...
  Future<void> _openAvatarPicker() async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AvatarPickerScreen(currentAvatar: _selectedAvatar),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    final continueLabel =
        _currentUser == null ? (isTV ? 'Continue' : 'Continue as Guest') : 'Continue';
    final avatarHint = isTV ? 'Press OK to change avatar' : 'Tap to change avatar';
