...
import 'package:zap_share/Screens/linux/LinuxFileShareScreen.dart';
import 'package:zap_share/Screens/linux/LinuxReceiveScreen.dart';
...
class _LinuxHomeScreenState extends State<LinuxHomeScreen> with WindowListener {
  ...
  Widget _buildDashboardGrid() {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: 16),
        // Third Row: Audio Share & Quick Help/Settings (Optional)
        Expanded(
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              ...
              Expanded(
                child: Hero(
                  tag: 'audio_share_card_container',
                  createRectTween: (begin, end) {
                    return RectTween(begin: begin, end: end);
                  },
                  child: _buildCard(
                    title: "Audio Share",
                    subtitle: "Stream System Audio",
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      ...
                      SmoothPageRoute.fade(
                        page: const DeviceSettingsScreen(),
  ...
  void _navigateToScreen(int index) {
    ...
    if (index == 0) {
      targetScreen = LinuxFileShareScreen();
    } else if (index == 1) {
      targetScreen = LinuxReceiveScreen();
    } else if (index == 2) {
      targetScreen = TransferHistoryScreen();
    } else if (index == 3) {
      targetScreen = const CastSelectionScreen();
    } else if (index == 4) {
