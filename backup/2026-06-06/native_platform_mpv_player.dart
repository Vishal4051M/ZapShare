...
//         await _sendCommand(['set_property', 'profile', 'low-latency']);
...
//       } else {
//         await _sendCommand(['set_property', 'profile', 'default']);
...
//         loadSource,
//         'replace',
//         'cache=no,demuxer-max-bytes=4096,demuxer-readahead-secs=0,audio-buffer=0,profile=low-latency,network-timeout=5'
//       ]);
//     } else {
