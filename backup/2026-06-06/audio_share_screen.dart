...
//     bool success = false;
//     try {
//       success = await _channel.invokeMethod('startLanAudioSender', {'ips': ips});
//     } catch (e) {
...
//       await _discoveryService.sendNativeSystemAudioOffer(targetIp, 50005, cushionMs: 20);
//     }
//     return true;
//   }
...
//       final useLanAudio = _isSystemAudio && Platform.isAndroid && _targetsAllAndroid();
//       if (useLanAudio) {
//         await _startNativeSystemAudio();
//       } else {
//         if (Platform.isAndroid && _isSystemAudio && !_targetsAllAndroid()) {
//           ScaffoldMessenger.of(context).showSnackBar(
//             const SnackBar(content: Text('Using WebRTC for cross-platform audio')),
//           );
//         }
...
//         if (!_targetsAllAndroid()) {
//           for (final ip in _selectedTargets) {
//             await _discoveryService.stopWebRtcAudio(ip);
//           }
//         }
//       } catch (_) {}
//     } else {
