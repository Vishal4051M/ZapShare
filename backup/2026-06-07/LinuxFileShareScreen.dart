...
class LinuxFileShareScreen extends StatefulWidget {
  const LinuxFileShareScreen({super.key});

  @override
  State<LinuxFileShareScreen> createState() => _LinuxFileShareScreenState();
}

class _LinuxFileShareScreenState extends State<LinuxFileShareScreen> {
  // Logic State
