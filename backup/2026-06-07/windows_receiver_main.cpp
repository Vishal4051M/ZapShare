...
void UdpReceiverThread() {
    ...
    std::cout << "Listening for ZapShare Audio on UDP port " << PORT << "..." << std::endl;
    ...
    // OPUS Setup
    {
        ...
        while (isRunning) {
            ...
            if (framesDecoded < 0) {
                ...
                // Let's assume raw PCM if decoding fails and payload matches our PCM frame size (1920 * 2 = 3840)
